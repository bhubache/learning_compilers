...
nix run nixpkgs#omnix -- \
  init github:srid/learning-compilers -o ./yourproject
```
...
Full instructions: https://srid.ca/learning-compilers/start
...
- Run the application without installing: `nix run github:srid/learning-compilers` (or `nix run .` from checkout)
- Common workflows
  - Adding library dependencies in Nix: https://community.flake.parts/haskell-flake/dependency
  - Adding tests: https://srid.ca/learning-compilers/tests

## Discussions

Questions? Ideas? Suggestions? Join our [NixOS Asia community](https://nixos.asia/en/#community) or post in [Github Discussions](https://github.com/srid/learning-compilers/discussions).
